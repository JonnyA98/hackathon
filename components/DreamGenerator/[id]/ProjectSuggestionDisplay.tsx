...
import { getStoredProject } from "@/lib/getStoredProject";

interface ProjectSuggestionDisplayProps {
  id: string;
}

export function ProjectSuggestionDisplay({
  id,
}: ProjectSuggestionDisplayProps) {
  ...
  const storedProject = useMemo(() => getStoredProject(id), [id]);
